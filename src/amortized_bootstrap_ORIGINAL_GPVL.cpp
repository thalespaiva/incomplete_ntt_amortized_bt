// THIS IS THE ORIGINAL FILE PROVIDED BY GUIMARÃES ET AL. UPON WHICH WE IMPLEMENTED
// OUR CODE.
//
// This is included for convenience, to make it easier to compare our changes, that
// can be found in file `amortized_bootstrap_general.cpp`
